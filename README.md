...
> Be patient! In ~3 mins your app is live, at your [app url](https://container-undtj0.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container-undtj0.containers.anotherwebservice.com/
...
```
git clone git@github.com:chemse78/container-undtj0.git
cd container-undtj0
```
...
```
docker attach container-undtj0
```
